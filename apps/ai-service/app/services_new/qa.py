...
async def answer_file_question(
    ...
    if _HAS_OPENAI:
        try:
            ...
            messages = [
                SystemMessage(content="You are a medical document assistant. Answer the user's question based on the document summary provided. Be specific and helpful. If the summary doesn't contain enough information, say so."),
    ...
    return (
        ...
        "This typically takes a few moments for thorough analysis of the uploaded file content."
    )
