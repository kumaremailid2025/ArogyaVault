...
async def get_rephrasings(text: str) -> list[str]:
    ...
    if _HAS_OPENAI:
        try:
            ...
            messages = [
                SystemMessage(content="You are a writing assistant. Given a message, provide exactly two rephrased versions separated by |||. First: a formal, polished version. Second: a concise, shorter version. Do not add any other text."),
